...
def get_permissao(
    ...
    """Retorna uma permissao especifica."""
    service = PerfilService(db)
...
def delete_permissao(
    ...
    """Exclui uma permissao."""
    service = PerfilService(db)
    service.delete_permissao(permissao_id)


# ========== Endpoints de Atribuicao de Perfis ==========
...
def remover_perfil(
    ...
    """Remove um perfil de um usuario."""
    service = PerfilService(db)
...
def get_perfis_usuario(
    ...
    """Retorna todos os perfis de um usuario."""
    service = PerfilService(db)
...
def get_permissoes_usuario(
    ...
    """Retorna todas as permissoes de um usuario atraves dos perfis."""
    service = PerfilService(db)
...
def delete_perfil(
    ...
    """Exclui um perfil apenas se nao for de sistema."""
    service = PerfilService(db)
